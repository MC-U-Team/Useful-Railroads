...
public class UsefulRailroadsModels {
	...
	public static void register(Register<Block> event) {
		...
		// ModelUtil.addCustomStateContainer(INTERSECTION_RAIL.getRegistryName(), (new
		// StateContainer.Builder<Block,
		// BlockState>(INTERSECTION_RAIL)).add(EnumProperty.create("shape",
		// RailShape.class, RailShape.NORTH_SOUTH,
		// RailShape.EAST_WEST)).create(BlockState::new));
