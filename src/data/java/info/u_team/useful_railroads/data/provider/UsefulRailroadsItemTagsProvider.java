...
// getBuilder(TRACK_BUILDER_RAILS).add(Items.POWERED_RAIL, UsefulRailroadsBlocks.HIGHSPEED_RAIL.get().asItem(),
// UsefulRailroadsBlocks.SPEED_CLAMP_RAIL.get().asItem());
