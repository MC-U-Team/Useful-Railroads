...
import info.u_team.u_team_core.recipetype.URecipeType;
...
public class UsefulRailroadsRecipeTypes {
	...
	public static final RegistryEntry<RecipeType<TeleportRailFuelRecipe>> TELEPORT_RAIL_FUEL = RECIPE_TYPES.register("teleport_rail_fuel", URecipeType::new);
	public static final RegistryEntry<RecipeType<TrackBuilderFuelRecipe>> TRACK_BUILDER_FUEL = RECIPE_TYPES.register("track_builder_fuel", URecipeType::new);
