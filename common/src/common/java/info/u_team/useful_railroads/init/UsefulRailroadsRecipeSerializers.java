...
public class UsefulRailroadsRecipeSerializers {
	...
	public static final CommonRegister<RecipeSerializer<?>> RECIPE_SERIALIZERS = CommonRegister.create(Registries.RECIPE_SERIALIZER, UsefulRailroadsReference.MODID);
